...
{
    double pset1[2][2] = {{0*M_PI/4,  1.0}, {1*M_PI/4,  1.0}};
    double pset2[2][2] = {{1*M_PI/4,  0.7}, {2*M_PI/4, -1.0}};
    double pset3[2][2] = {{2*M_PI/4,  1.0}, {3*M_PI/4, -0.7}};
    double pset4[2][2] = {{3*M_PI/4, -0.7}, {4*M_PI/4,  1.0}};
    double pset5[2][2] = {{4*M_PI/4,  1.0}, {5*M_PI/4,  0.7}};
    double pset6[2][2] = {{5*M_PI/4,  0.7}, {6*M_PI/4, -1.0}};
    double pset7[2][2] = {{6*M_PI/4, -1.0}, {7*M_PI/4, -0.7}};
    double pset8[2][2] = {{7*M_PI/4, -0.7}, {8*M_PI/4,  1.0}};
...
{
    double pset1[2][2] = {{0*M_PI/4, -1.0}, {1*M_PI/4,  0.0}};
    double pset2[2][2] = {{1*M_PI/4,  0.0}, {2*M_PI/4,  0.7}};
    double pset3[2][2] = {{2*M_PI/4,  0.7}, {3*M_PI/4,  1.0}};
    double pset4[2][2] = {{3*M_PI/4,  1.0}, {4*M_PI/4,  1.0}};
    double pset5[2][2] = {{4*M_PI/4,  1.0}, {5*M_PI/4,  0.7}};
    double pset6[2][2] = {{5*M_PI/4,  0.7}, {6*M_PI/4, -1.0}};
    double pset7[2][2] = {{6*M_PI/4, -1.0}, {7*M_PI/4, -0.7}};
    double pset8[2][2] = {{7*M_PI/4, -0.7}, {8*M_PI/4,  1.0}};
