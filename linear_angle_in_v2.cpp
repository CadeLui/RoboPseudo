...
int main(void)
{
    ...
    for (int i = 0; i < yVals.size(); i++)
    {
        ...
        << i*iterator <<  " | "
        << leftMotorMod(xVals.at(i), sqrt(xVals.at(i)*xVals.at(i) + yVals.at(i)*yVals.at(i)), yVals.at(i)) << " | " 
        << rightMotorMod(xVals.at(i), sqrt(xVals.at(i)*xVals.at(i) + yVals.at(i)*yVals.at(i)), yVals.at(i)) << " | "
        <<"\n";
    }
    std::cout << "\n";
    return 0;
